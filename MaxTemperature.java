...
fs.copyToLocalFile(false, status[i].getPath(), new Path("/home/anindita/"+args[1]));
}
System.out.println("\nYear\tTemperature\n");
//display contents of local file
BufferedReader br = new BufferedReader(new FileReader("/home/anindita/"+args[1]));
String line = null;
while ((line = br.readLine()) != null) {
System.out.println(line);
}
br.close();
Scanner s = new Scanner(new File("/home/anindita/"+args[1]));
...
System.out.println("\tTemperature:"+max_temp1+" Degree Celcius");
for (int temp: temps)
{
if(temp<min_temp)
{
...
System.out.println("\tTemperature:"+min_temp1+" Degree Celcius");
s.close();
}
}